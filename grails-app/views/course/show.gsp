	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<g:if test="${courseInstance?.ects}">
				<li class="fieldcontain">
					<span id="ects-label" class="property-label"><g:message code="course.ects.label" default="Ects" /></span>
					
						<span class="property-value" aria-labelledby="ects-label"><g:fieldValue bean="${courseInstance}" field="ects"/></span>
